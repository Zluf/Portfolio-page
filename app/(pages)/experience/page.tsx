      ...
      <div className="textWrapper">
        <div className={classes.expEntry}>
          ...
          <p>
            ...
            Sophia. I'm also involved in the front end development of other
            Spring Act's future projects and have participated in their 2024
            Hackathon.
          </p>
        </div>
        ...
        <div className={classes.expEntry}>
          ...
          <p>
            ...
            of sessions I would join improvised teams to solve coding katas in
            the paradigm of Test-Driven Development. Other sessions would be
            dedicated to the discussion of Tech-related problems and their
            possible solutions. The group is run by the Manchester branch of
            Codurance, a global software consultancy.
          </p>
        </div>
        ...
        <div className={classes.expEntry}>
          ...
          <p>
            ...
            competition in the category of Access to Justice. Review of the
