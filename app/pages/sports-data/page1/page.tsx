...
export default function SpartsDataPage1() {
  return (
    <>
      ...
      <div className="layer-3-container">
        <div className="logo">
          ...
          <img
            src="/pages-img/sports-data/page1/dat-driven-sport.png"
          ...
          <div className="cont1">
            <article>
              ...
              <div className="banner">
                <img
                  src="/pages-img/sports-data/page1/coat.png"
            ...
            <article>
              ...
              <div className="banner">
                <img
                  src="/pages-img/sports-data/page1/cup.png"
                  alt="The Open"
                />
                <p>The Open</p>
              </div>
      ...
      <footer>
        ...
        <div className="footer-right">
          ...
          <div className="language">
            <nav>
              <a href="#">
                <img src="/pages-img/sports-data/page1/de.png" alt="" />
                Ger
              </a>
              <a href="#">
                <img src="/pages-img/sports-data/page1/it.png" alt="" />
                Ita
              </a>
              <a href="#">
                <img src="/pages-img/sports-data/page1/fr.png" alt="" />
                Fr
              </a>
              <a href="#">
                <img src="/pages-img/sports-data/page1/uk.png" alt="" />
                GB
              </a>
            </nav>
          </div>
